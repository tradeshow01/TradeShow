                ...
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <h4 class="mt-4 mb-3"><a href="javascript:void(0)">A REAL TRADING COMMUNITY</a></h4>
                            <p>Learn tips and trick to determine your Directional Bias, Find Entries and Exit points, Risk Management, Money Management, How to Develop the Trader’s Psychology, and more.</p>
                ...
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <h4 class="mt-4 mb-3"><a href="javascript:void(0)">PROFITABLE TRADE IDEAS</a></h4>
                            <p>High probability trade signals sent right to your fingertips each day and all you have to do is plug them in. Let us do all the groundwork so all you have to do is EXECUTE!
                ...
                <div class="col-lg-4 col-md-12 iq-mt-20">
                    <div class="iq-features1">
                        ...
                        <div class="iq-blog">
                            ...
                            <h4 class="mt-4 mb-3"><a href="javascript:void(0)">FOREX TRAINING VIDEO LIBRARY</a></h4>
                            <p>100’s of training videos, including Smart Money concepts, Naked Price Action, and more.
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 counter-blog">
                    <div class=" text-white">
                        <h3  class="title bestservices iq-mb-25 text-white">Best Service, Right Time, Right People</h3>
