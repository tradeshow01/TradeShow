...
<!-- Mirrored from templates.iqonic.design/coinex/html/dark/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Jul 2022 17:58:41 GMT -->
...
<body>
                            ...
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <ul class="list-inline iq-left">
                                        <li class="list-inline-item"><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".iq-login" data-bs-whatever="@mdo"><i class="fa fa-lock"></i>Login</a></li>
                                        <li class="list-inline-item"><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".iq-register" data-bs-whatever="@mdo"><i class="fa fa-user"></i>Register</a></li>
                                    </ul>
                                </li>
        ...
        <div class="iq-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="home-1.html"><img id="logo_dark" class="img-fluid" src="images/logo.png" alt="logo"></a>
                        </div>
                            ...
                            <ul class="menu text-end">
                                ...
                                <li><a href="javascript:void(0)">Pages</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="javascript:void(0)">Services <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                        ...
                                        <li><a href="javascript:void(0)">Team <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                        ...
                                        <li><a href="javascript:void(0)">Pricing <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                                <li><a href="pricing.html">Pricing 1</a></li>
                                                <li><a href="pricing-1.html">Pricing 2</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="javascript:void(0)">Faq <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                                <li><a href="faqs-1.html">Faq 1</a></li>
                                                <li><a href="faqs-2.html">Faq 2</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="javascript:void(0)">Coming Soon <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                                <li><a href="coming-soon-1.html">Coming Soon 1</a></li>
                                                <li><a href="coming-soon-2.html">Coming Soon 2</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="javascript:void(0)">Error <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                                <li><a href="error-404-1.html">Error 404 1</a></li>
                                                <li><a href="error-404-2.html">Error 404 2</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="javascript:void(0)">Breadcrumb <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                            <ul>
                                ...
                                <li>
                                    <div class="iq-search"> <a class="search-btn not_click" href="javascript:void(0);">
                                            <span>Search Button</span></a>
    ...
    <div class="main-content">
        <!-- Action Box -->
        <section class="overview-block-ptb6 banner-stars action-box dark-bg">
            <div class="container">
                <div class="row h-100">
                    <div class="col-lg-9 col-md-12 text-white">
                        <h3 class="text-white mb-3 ">Do You Need a Consultant?</h3>
                        <div>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took
                    ...
                    <div class="col-lg-3 col-md-12 text-end align-self-center">
                        <a class="button" href="javascript:void(0)">
                            <span class="button-inner-box">
                                ...
                                <span class="text-btn">Click Here</span>
        ...
        <!-- Action Box -->
        <!-- How it Works -->
        <section class="overview-block-pt6">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-feature-3 iq-mt-20 dark-bg">
                            <div class="fancy-content">
                                ...
                                <hr class="iq-mtb-40">
                                <h4 class=" mb-3">Fill Up Your Form</h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-feature-3 iq-mt-20 dark-bg">
                            <div class="fancy-content">
                                ...
                                <hr class="iq-mtb-40">
                                <h4 class=" mb-3">Buy or Sell Coin</h4>
                                <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    industry. Lorem Ipsum has been the industry's standard dummy text ever since the
                                    1500s.</p>
                    ...
                    <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="3" data-items-laptop="3" data-items-tab="2" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                        <div class="item">
                            <div class="feature-aria">
                                <div class="feature-img"><img alt="" class="img-fluid" src="images/about-us/04.jpg">
                                </div>
                                <div class="feature-content dark-bg">
                                    <h6 class="iq-font-yellow mb-2">Service 1</h6>
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">Fast Transaction</a>
                                    </h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil
                                        printer took a galley of type and scram bled it to make a type specimen book.
                                    </p>
                                    <div class="read-more green"><a href="javascript:void(0)">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="feature-aria">
                                <div class="feature-img"><img alt="" class="img-fluid" src="images/about-us/05.jpg">
                                </div>
                                <div class="feature-content dark-bg">
                                    <h6 class="iq-font-yellow mb-2">Creative</h6>
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">Secure table</a></h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil
                                        printer took a galley of type and scram bled it to make a type specimen book.
                                    </p>
                                    <div class="read-more green"><a href="javascript:void(0)">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                        ...
                        <div class="item">
                            <div class="feature-aria">
                                <div class="feature-img"><img alt="" class="img-fluid" src="images/about-us/06.jpg">
                                </div>
                                <div class="feature-content dark-bg">
                                    <h6 class="iq-font-yellow mb-2">Outstanding</h6>
                                    <h4 class="iq-font-dark mb-3 "><a href="services-details.html">Coin Exchange</a>
                                    </h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil
                                        printer took a galley of type and scram bled it to make a type specimen book.
                                    </p>
                        ...
                        <div class="item">
                            <div class="feature-aria">
                                ...
                                <div class="feature-content dark-bg">
                                    <h6 class="iq-font-yellow mb-2">Awesome</h6>
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">Mobile Apps</a></h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil
                                        printer took a galley of type and scram bled it to make a type specimen book.
                                    </p>
                                    <div class="read-more green"><a href="javascript:void(0)">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                        ...
                        <div class="item">
                            <div class="feature-aria">
                                ...
                                <div class="feature-content dark-bg">
                                    <h6 class="iq-font-yellow mb-2">Creative</h6>
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">24/7 Trading</a></h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil
                                        printer took a galley of type and scram bled it to make a type specimen book.
                                    </p>
                                    <div class="read-more green"><a href="javascript:void(0)">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                        ...
                        <div class="item">
                            <div class="feature-aria">
                                ...
                                <div class="feature-content dark-bg">
                                    <h6 class="iq-font-yellow mb-2">Outstanding</h6>
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">Free Consulting</a>
                                    </h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil
                                        printer took a galley of type and scram bled it to make a type specimen book.
                                    </p>
        ...
        <!-- Features -->
        <!-- About Us -->
        <section class="overview-block-pt iq-about1 iq-bg iq-over-black-80 jarallax" style="background-image: url('images/bg/bg-5.png'); background-position: left center;">
            <div class="container">
                <div class="row h-100">
                    <div class="">
                        <img class="img-fluid iq-img" src="images/about-us/about-img1.png" alt="">
                    </div>
                    <div class="col-lg-5 col-md-12 iq-mb-80 offset-xl-3">
                        <h2 class="text-white ">Everything
                            <br><span class="iq-font-yellow">You Need To Know!</span>
                        </h2>
                        <p class="text-white iq-mt-25">Lorem Ipsum has been the industry's standard dummy text ever
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="heading-left">
                            <h2 class="title ">Recent Market</h2>
                    ...
                    <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="3" data-items-laptop="3" data-items-tab="2" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                        <div class="item">
                            <div class="team-blog iq-pall-20 text-center">
                                ...
                                <div class="iq-font-yellow iq-mt-20">
                                    <h5 class="iq-font-dark "> <a href="team-details.html"> Rinks Cooper</a></h5>
                                    <small>CEO, CoinEx</small>
                                </div>
                                <p class="mt-2">Simply dummy text ever sincehar the 1500s, when an unknownshil printer
                        ...
                        <div class="item">
                            <div class="team-blog iq-pall-20 text-center">
                                ...
                                <div class="iq-font-yellow iq-mt-20">
                                    <h5 class="iq-font-dark "> <a href="team-details.html">JD Scot</a></h5>
                                    <small>CEO, CoinEx</small>
                                </div>
                                <p class="mt-2">Simply dummy text ever sincehar the 1500s, when an unknownshil printer
                                    took a galley of type and scrambled it to make a type specimen book.</p>
                        ...
                        <div class="item">
                            <div class="team-blog iq-pall-20 text-center">
                                ...
                                <div class="iq-font-yellow iq-mt-20">
                                    <h5 class="iq-font-dark "> <a href="team-details.html">Haris Morgan</a></h5>
                                    <small>CEO, CoinEx</small>
                                </div>
                                <p class="mt-2">Simply dummy text ever sincehar the 1500s, when an unknownshil printer
                                    took a galley of type and scrambled it to make a type specimen book.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-news-box">
                            ...
                            <div class="iq-news-detail iq-pall-30 dark-bg">
                                <div class="news-title mb-4 mt-3"> <a href="javascript:void(0)">
                                        <h5 class="">How One Fund Used the Carry Trade to Beat</h5>
                                    </a> </div>
                                <div class="d-flex align-items-center mt-2">
                                    <small class="border-end text-white pe-2">Power by:Michale Scott</small>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-news-box">
                            ...
                            <div class="iq-news-detail iq-pall-30 dark-bg">
                                <div class="news-title mb-4 mt-3"> <a href="javascript:void(0)">
                                        <h5 class="">The Best Set and Forget Strategies for Investing</h5>
                                    </a> </div>
                                <div class="d-flex align-items-center mt-2">
                                    <small class="border-end text-white pe-2">Power by:Michale Scott</small>
                                    <small class="iq-font-yellow  ms-2 ">Business</small>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-news-box">
                            ...
                            <div class="iq-news-detail iq-pall-30 dark-bg">
                                <div class="news-title mb-4 mt-2"> <a href="javascript:void(0)">
                                        <h5 class="">What is Central Bank Digital Currency (CBDC)?</h5>
                                    </a> </div>
                                <div class="d-flex align-items-center mt-2">
                                    <small class="border-end text-white pe-2">Power by:Michale Scott</small>
                                    <small class="iq-font-yellow  ms-2 ">Business</small>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="logo">
                            ...
                            <div class="text-white iq-mt-15">Lorem Ipsum is simply dummy text of the printing and
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 iq-contact iq-r4-mt-40">
                        <div class="heading-left">
                            <h5 class="title  text-white">Contact CoinEx</h5>
                        </div>
                        <div class="iq-mb-20">
                        ...
                        <div class="iq-mb-20">
                            <div class="blog "><i class="ion-ios-email-outline"></i>
                                <div class="content">
                                    <div class=" title ">Mail</div> mail@coinex.com
                                </div>
                            </div>
                        </div>
                        <div class="blog"><i class="ion-ios-location-outline"></i>
                            <div class="content">
                                <div class=" title ">Address</div> 1234 North Luke Lane, South Bend,IN 360001
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 iq-r-mt-40">
                        <div class=" heading-left">
                            <h5 class="title  text-white">Newsletter</h5>
                        </div>
                        <p class="text-white">Lorem Ipsum passages, and more recently with desktop publishing software
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="iq-copyright iq-mt-10 text-white">Copyright <span id="copyright">
                            ...
                            </span> <a href="javascript:void(0)">CoinEx</a> All Rights Reserved </div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown
                            printer took a galley of type and scrambled it to make a type specimen book.</p>
                        <a class="button iq-mtb-10" href="javascript:void(0)">
                            <span class="button-inner-box"></span>
                            <span>Sign Up</span>
                            </span>
                        </a>
                    </form>
